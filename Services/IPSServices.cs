...
{
    [Export(typeof(IIPSServices))]
    internal class IPSServices: IIPSServices, IDisposable
    {
        internal const string TAG = "IPSServices";
        ...
        public IPSServices(IGeofenceManager geofenceManager, IMapObjectItemManager mapObjectItemManager, INotificationLog notificationLog)
        {
